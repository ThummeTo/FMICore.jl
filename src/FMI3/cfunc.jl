...
function fmi3InstantiateModelExchange(
    ...
    inst = ccall(
        cfunc,
        fmi3Instance,
        (Cstring, Cstring, Cstring, Cuint, Cuint, Ptr{Cvoid}, Ptr{Cvoid}),
        instanceName,
    ...
    @debug "fmi3InstantiateModelExchange(instanceName: $(instanceName), fmuInstantiationToken: $(fmuInstantiationToken), fmuResourceLocation: $(fmuResourceLocation), visible: $(visible), loggingOn: $(loggingOn)) → $(inst)"
    return inst
end
...
function fmi3InstantiateCoSimulation(
    ...
    @debug "fmi3InstantiateCoSimulation(instanceName: $(instanceName), fmuInstantiationToken: $(fmuInstantiationToken), fmuResourceLocation: $(fmuResourceLocation), visible: $(visible), loggingOn: $(loggingOn)) → $(inst)"
    return inst
end
...
function fmi3InstantiateScheduledExecution(
    ...
    @debug "fmi3InstantiateScheduledExecution(instanceName: $(instanceName), fmuInstantiationToken: $(fmuInstantiationToken), fmuResourceLocation: $(fmuResourceLocation), visible: $(visible), loggingOn: $(loggingOn)) → $(inst)"
    return inst
end
...
"""
function fmi3GetVersion(cfunc::Ptr{Nothing})::fmi3String
...
"""
function fmi3FreeInstance(cfunc::Ptr{Nothing}, c::fmi3Instance)::Nothing
...
"""
function fmi3ExitInitializationMode(cfunc::Ptr{Nothing}, c::fmi3Instance)::fmi3Status
...
"""
function fmi3Terminate(cfunc::Ptr{Nothing}, c::fmi3Instance)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance,), c)
...
"""
function fmi3Reset(cfunc::Ptr{Nothing}, c::fmi3Instance)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance,), c)
...
function fmi3GetFMUState!(
    ...
    status = ccall(cfunc, fmi3Status, (fmi3Instance, Ptr{fmi3FMUState}), c, FMUstate)
...
function fmi3SetFMUState(
    ...
    status = ccall(cfunc, fmi3Status, (fmi3Instance, fmi3FMUState), c, FMUstate)
...
"""
function fmi3EnterConfigurationMode(cfunc::Ptr{Nothing}, c::fmi3Instance)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance,), c)
...
"""
function fmi3ExitConfigurationMode(cfunc::Ptr{Nothing}, c::fmi3Instance)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance,), c)
...
function fmi3GetNumberOfContinuousStates!(
    cfunc::Ptr{Nothing},
    c::fmi3Instance,
    nContinuousStates::Ref{Csize_t},
)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance, Ptr{Csize_t}), c, nContinuousStates)
...
function fmi3GetNumberOfEventIndicators!(
    cfunc::Ptr{Nothing},
    c::fmi3Instance,
    nEventIndicators::Ref{Csize_t},
)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance, Ptr{Csize_t}), c, nEventIndicators)
...
"""
function fmi3EvaluateDiscreteStates(cfunc::Ptr{Nothing}, c::fmi3Instance)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance,), c)
...
function fmi3EnterContinuousTimeMode(cfunc::Ptr{Nothing}, c::fmi3Instance)
    status = ccall(cfunc, fmi3Status, (fmi3Instance,), c)::fmi3Status
...
"""
function fmi3EnterStepMode(cfunc::Ptr{Nothing}, c::fmi3Instance)::fmi3Status
    status = ccall(cfunc, fmi3Status, (fmi3Instance,), c)
...
function fmi3SetContinuousStates(
    ...
    status = ccall(cfunc, fmi3Status, (fmi3Instance, Ptr{fmi3Float64}, Csize_t), c, x, nx)
