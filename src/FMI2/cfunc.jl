...
function fmi2Instantiate(
    ...
    @debug "fmi2Instantiate(instanceName: $(instanceName), fmuType: $(fmuType), fmuGUID: $(fmuGUID), fmuResourceLocation: $(fmuResourceLocation), functions: $(functions), visible: $(visible), loggingOn: $(loggingOn)) → $(comp)"
    return comp
end
...
"""
function fmi2FreeInstance(cfunc::Ptr{Cvoid}, c::fmi2Component)::Nothing
...
"""
function fmi2GetTypesPlatform(cfunc::Ptr{Cvoid})::fmi2String
...
"""
function fmi2GetVersion(cfunc::Ptr{Cvoid})::fmi2String
    str = ccall(cfunc, fmi2String, ())
...
function fmi2EnterInitializationMode(cfunc::Ptr{Cvoid}, c::fmi2Component)
    status = ccall(cfunc, fmi2Status, (fmi2Component,), c)::fmi2Status
...
function fmi2GetInteger!(
    ...
    vr::Union{AbstractArray{fmi2ValueReference},Ptr{fmi2ValueReference}},
    nvr::Csize_t,
    value::Union{AbstractArray{fmi2Integer},Ptr{fmi2Integer}},
)::fmi2Status
    status = ccall(
        cfunc,
        fmi2Status,
...
function fmi2GetBoolean!(
    ...
    vr::Union{AbstractArray{fmi2ValueReference},Ptr{fmi2ValueReference}},
    nvr::Csize_t,
    value::Union{AbstractArray{fmi2Boolean},Ptr{fmi2Boolean}},
)::fmi2Status
    status = ccall(
        cfunc,
        fmi2Status,
...
function fmi2GetString!(
    ...
    vr::Union{AbstractArray{fmi2ValueReference},Ptr{fmi2ValueReference}},
    nvr::Csize_t,
    value::Union{AbstractArray{fmi2String},Ptr{fmi2String}},
)::fmi2Status
    status = ccall(
        cfunc,
        fmi2Status,
...
"""
function fmi2GetFMUstate!(
    cfunc::Ptr{Cvoid},
    c::fmi2Component,
    FMUstate::Ref{fmi2FMUstate},
)::fmi2Status
    status = ccall(cfunc, fmi2Status, (fmi2Component, Ptr{fmi2FMUstate}), c, FMUstate)
...
function fmi2SetFMUstate(
    ...
    status = ccall(cfunc, fmi2Status, (fmi2Component, fmi2FMUstate), c, FMUstate)
...
"""
function fmi2CancelStep(cfunc::Ptr{Cvoid}, c::fmi2Component)::fmi2Status
    status = ccall(cfunc, fmi2Status, (fmi2Component,), c)
...
"""
function fmi2GetStatus!(
    cfunc::Ptr{Cvoid},
    c::fmi2Component,
    s::fmi2StatusKind,
    value::Ptr{fmi2Status},
)::fmi2Status
    status = ccall(
        cfunc,
        fmi2Status,
...
Informs the master about the actual status of the simulation run. Which status information is to be returned is specified by the argument fmi2StatusKind.
"""
function fmi2GetBooleanStatus!(
    cfunc::Ptr{Cvoid},
    c::fmi2Component,
    s::fmi2StatusKind,
    value::Ptr{fmi2Boolean},
)::fmi2Status
    status = ccall(
        cfunc,
        fmi2Status,
...
Informs the master about the actual status of the simulation run. Which status information is to be returned is specified by the argument fmi2StatusKind.
"""
function fmi2GetStringStatus!(
    cfunc::Ptr{Cvoid},
    c::fmi2Component,
    s::fmi2StatusKind,
    value::Ptr{fmi2String},
)::fmi2Status
    status = ccall(
        cfunc,
        fmi2Status,
...
"""
function fmi2SetTime(cfunc::Ptr{Cvoid}, c::fmi2Component, time::fmi2Real)::fmi2Status
    status = ccall(cfunc, fmi2Status, (fmi2Component, fmi2Real), c, time)
...
function fmi2SetContinuousStates(
    ...
    status = ccall(cfunc, fmi2Status, (fmi2Component, Ptr{fmi2Real}, Csize_t), c, x, nx)
...
"""
function fmi2EnterEventMode(cfunc::Ptr{Cvoid}, c::fmi2Component)::fmi2Status
    status = ccall(cfunc, fmi2Status, (fmi2Component,), c)
...
function fmi2NewDiscreteStates!(
    ...
    status = ccall(cfunc, fmi2Status, (fmi2Component, Ptr{fmi2EventInfo}), c, eventInfo)
...
"""
function fmi2EnterContinuousTimeMode(cfunc::Ptr{Cvoid}, c::fmi2Component)::fmi2Status
    status = ccall(cfunc, fmi2Status, (fmi2Component,), c)
...
function fmi2GetEventIndicators!(
    cfunc::Ptr{Cvoid},
    c::fmi2Component,
    eventIndicators::Union{AbstractArray{fmi2Real},Ptr{fmi2Real}},
    ni::Csize_t,
)::fmi2Status
    status = ccall(
        cfunc,
...
"""
function fmi2GetNominalsOfContinuousStates!(
    cfunc::Ptr{Cvoid},
    c::fmi2Component,
    x_nominal::Union{AbstractArray{fmi2Real},Ptr{fmi2Real}},
    nx::Csize_t,
)::fmi2Status
    status =
        ccall(cfunc, fmi2Status, (fmi2Component, Ptr{fmi2Real}, Csize_t), c, x_nominal, nx)
