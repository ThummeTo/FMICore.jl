...
# 2.1.5
function unload_fmi2Instantiate(
...
function unload_fmi2SetDebugLogging(
...
function unload_fmi2SetupExperiment(
    _component::fmi2Component,
...
function unload_fmi2GetInteger(
    _component::fmi2Component,
    _vr::Ptr{fmi2ValueReference},
    nvr::Csize_t,
...
function unload_fmi2GetBoolean(
    _component::fmi2Component,
    _vr::Ptr{fmi2ValueReference},
    nvr::Csize_t,
...
function unload_fmi2SetInteger(
    _component::fmi2Component,
    _vr::Ptr{fmi2ValueReference},
    nvr::Csize_t,
    _value::Ptr{fmi2Integer},
...
function unload_fmi2SetBoolean(
    _component::fmi2Component,
    _vr::Ptr{fmi2ValueReference},
    nvr::Csize_t,
    _value::Ptr{fmi2Boolean},
...
function unload_fmi2SetTime(_component::fmi2Component, time::fmi2Real)::fmi2Status
    @assert false "The function `fmi2SetTime` is not callable anymore, because the FMU is unloaded!"
    return fmi2StatusFatal
end

function unload_fmi2SetContinuousStates(
    _component::fmi2Component,
    _x::Ptr{fmi2Real},
    nx::Csize_t,
)::fmi2Status
...
function unload_fmi2EnterEventMode(_component::fmi2Component)::fmi2Status
    @assert false "The function `fmi2EnterEventMode` is not callable anymore, because the FMU is unloaded!"
    return fmi2StatusFatal
end

function unload_fmi2NewDiscreteStates(
    _component::fmi2Component,
...
function unload_fmi2EnterContinuousTimeMode(_component::fmi2Component)::fmi2Status
    @assert false "The function `fmi2EnterContinuousTimeMode` is not callable anymore, because the FMU is unloaded!"
    return fmi2StatusFatal
end

function unload_fmi2CompletedIntegratorStep(
    _component::fmi2Component,
...
function unload_fmi2GetDerivatives(
    _component::fmi2Component,
...
function unload_fmi2GetEventIndicators(
    _component::fmi2Component,
...
function unload_fmi2GetContinuousStates(
    _component::fmi2Component,
    _x::Ptr{fmi2Real},
    nx::Csize_t,
)::fmi2Status
...
function unload_fmi2GetNominalsOfContinuousStates(
    _component::fmi2Component,
...
# ToDo: This should be doable with a macro like @unloaded_version fmi2GetContinuousStates
